        ...
        widgets = {
            "title": forms.TextInput(
                attrs={
                    ...
                    "class": "w-full px-4 py-3 text-2xl font-bold rounded border border-gb-border dark:border-gb-dark-border bg-gb-surface dark:bg-gb-dark-surface text-gb-text dark:text-gb-dark-text focus:outline-none focus:border-gb-accent transition-colors",
                }
            ),
